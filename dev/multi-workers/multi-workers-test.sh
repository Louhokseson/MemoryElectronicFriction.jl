...
#SBATCH --ntasks=44                  # Total number of tasks across both nodes (40 tasks per node)
#SBATCH --ntasks-per-node=22         # number of task/process in a node
#SBATCH --cpus-per-task=2           # threads per task/process
